...
syn keyword gbAsmOp adc add and bit ccf cp cpl daa dec di ei ex halt _halt inc ld ldd ldi ldh ldio nop or pop push res reti rl rla rlc rlca rr rra rrc rrca rst sbc scf set sla sra srl stop sub swap xor call ret
...
syn keyword asmKeyword db dw ds section equ set rsreset rsset rb rw equs macro endm purge rept endr include incbin if else endc def
...
iab _gbpic ;   12345678dw `........ ; 1dw `........ ; 2dw `........ ; 3dw `........ ; 4dw `........ ; 5dw `........ ; 6dw `........ ; 7dw `........ ; 8
